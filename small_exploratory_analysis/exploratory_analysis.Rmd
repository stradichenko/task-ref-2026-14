...
multi-centre clinical trial. The package ships with **20 cached datasets**
covering domains such as adverse events (ADAE), ECG (ADEG), exposure (ADEX),
...
and longitudinal safety tracking---and that let us build a clear progression in
...
<details>
<summary><strong>Click to expand: all 20 cached datasets</strong></summary>
