...
The package ships with **20 cached datasets** covering domains such as adverse events (ADAE), ECG (ADEG), exposure (ADEX),
...
From the 20 available cached CDISC datasets we load the four selected above and
